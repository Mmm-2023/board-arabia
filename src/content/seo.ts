...
export const OG_IMAGE_ALT = 'Board Arabia mark on Night Indigo'
export const OG_IMAGE_WIDTH = '1200'
export const OG_IMAGE_HEIGHT = '630'
export const OG_IMAGE_TYPE = 'image/png'

/** WhatsApp share card. Document titles stay page-specific. */
export const OG_SHARE_TITLE = 'Board Arabia'
